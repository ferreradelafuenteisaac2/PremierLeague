...
class DataBase {
    constructor() {
        this._cadenaConexion = `mongodb+srv://Admin:Admin@cluster0.0gnym.mongodb.net/Premier?retryWrites=true&w=majority`;
        this._cadenaConexion2 = `mongodb+srv://***:****@cluster0.sentg.mongodb.net/test?retryWrites=true&w=majority`;
